...
describe('Cinema', function () {
  ...
  it('should be able to find a film by title', function(){
    assert.deepStrictEqual(cinema.filmsByProperty("title", "Blade Runner 2049"), [bladeRunner])
  });
  ...
  it('should be able to check whether there are some films from a particular year', function () {
    assert.strictEqual(cinema.isYearPresent(2017), true)
  });

  it('should be able to check whether there are no films from a particular year', function () {
    assert.strictEqual(cinema.isYearPresent(2015), false)
  });

  it('should be able to check whether all films are over a particular length', function() {
    assert.strictEqual(cinema.areFilmsLongerThan(90), true)
    assert.strictEqual(cinema.areFilmsLongerThan(200), false)
  });
